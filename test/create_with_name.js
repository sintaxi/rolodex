...
describe("create with first and/or last name", function(){
  ...
  it("should not create account if first name or last name is longer than 64 characters", function(done) {
    ...
    rolodex.account.set(accountParams, function(errors, account){
      ...
      errors.messages.should.include("first_name must be 64 characters or less")
      errors.messages.should.include("last_name must be 64 characters or less")
      done()
    })
  })
  ...
  it("should not create account if first name or last name contain invalid characters", function(done) {
    ...
    rolodex.account.set(accountParams, function(errors, account){
      ...
      errors.messages.should.include("first_name must only contain alpha, space and/or period characters")
      errors.messages.should.include("last_name must only contain alpha, space and/or period characters")
      done()
    })
  })
  ...
  it("should not create account if first name or last name are empty", function(done) {
    ...
    rolodex.account.set(accountParams, function(errors, account){
      ...
      errors.messages.should.include("first_name must not be empty")
      errors.messages.should.include("last_name must not be empty")
      done()
    })
  })
